					...
					<div class="row">
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								...
								<!-- Cart -->
								<div class="dropdown">
									<a href="http://localhost:8080/Pentalver/deconnection">
										<i class="fa fa-user-o"></i>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li><a href="http://localhost:8080/Pentalver/conteneur">Categories</a></li>
						...
						<div class="aside">
							...
							<div class="product-widget">
								...
								<div class="product-body">
												...
												<h3 class="product-name"><a href="http://localhost:8080/Pentalver/conteneur?id_c=4">CONTENEUR PLATEAU STOCKAGE SECHE</a></h3>
							...
							<div class="product-widget">
								...
								<div class="product-body">
												<p class="product-category">FLAT RACK</p>
												<h3 class="product-name"><a href="http://localhost:8080/Pentalver/conteneur?id_c=7">MSC FLAT RACK 1/50 CONTENEUR SCALE 20</a></h3>
							...
							<div class="product-widget">
								...
								<div class="product-body">
												...
												<h3 class="product-name"><a href="http://localhost:8080/Pentalver/conteneur?id_c=2">CONTENEUR DE PENSEE  AWS 40 OPEN TOP</a></h3>
						...
						<c:forEach items="${ conteneur }" var="conteneur">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<a  class="add-to-cart-btn" href="http://localhost:8080/Pentalver/conteneur?id_c=${ conteneur.id_conteneur }">Plus d'Info</a>
									</div>
								</div>
							</div>
